...
const defineClass = (superclass: typeof Element, attributes: object) =>
...
export default function attributes<A extends object>(attr: A): Mixin<typeof WithAttributes & Constructor<A>> {
  return (superclass: any) => <any>defineClass(<typeof Element>superclass, Object.assign({}, superclass['attributes'], attr))
}
