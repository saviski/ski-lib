...
export function mixwith<T, U, V>(
  superclass: T,
  a: Mixin<U>,
  b: Mixin<V>
): Mix<Mix<T, U>, V>
export function mixwith<T, U, V, W>(
  superclass: T,
  a: Mixin<U>,
  b: Mixin<V>,
  c: Mixin<W>
): Mix<Mix<Mix<T, U>, V>, W>
export function mixwith<T, U, V, W, X>(
  superclass: T,
  a: Mixin<U>,
  b: Mixin<V>,
  c: Mixin<W>,
...
export function inject(prototype: any, mixin: Mixin<any>) {
  return Object.setPrototypeOf(
    prototype.constructor,
    mixin(Object.getPrototypeOf(prototype.constructor))
  )
}
